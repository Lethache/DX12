...
void WindowController::RegClass(HINSTANCE _hInstance)
{
    ...
    m_wClass.style = WS_VISIBLE | WS_CLIPCHILDREN | WS_CLIPSIBLINGS;
    ...
    m_wClass.hbrBackground = (HBRUSH)(COLOR_WINDOW + 2);
...
void WindowController::GetPrimaryMonitorResolution()
{
    ...
    M_ASSERT(
        GetMonitorInfo(primMon, &monitorInfo) == TRUE,
...
{
    m_windowPosX =
        (m_monitorWidth / 2) - (m_windowWidth / 2);

    m_windowPosY =
        (m_monitorHeight / 2) - (m_windowHeight / 2);
}
